...
const changeModalState = state => {
  const windowForm = document.querySelectorAll('.balcon_icons_img'),
        ...
        windowProfile = document.querySelectorAll('.chexkbox');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width'), Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#heigth');
...
const forms = state => {
  ...
  const message = {
    loading: 'Загрузка...',
    sucsess: 'Сапсибо! Скоро мы с вами свяжемся',
